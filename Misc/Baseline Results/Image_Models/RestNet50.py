...
def preprocess_and_extract_features(image_path):
    """Preprocess an image from a local path and extract features using ResNet50."""
    try:
...
if __name__ == "__main__":
    # Load the DataFrame
    df = pd.read_csv('/Users/dhyanpatel/Desktop/IR/image-similarity/train.csv')
    ...
    # Save the results
    save_data(image_features_with_path, '/Users/dhyanpatel/Desktop/IR/image-similarity/train_image_features.pkl')
